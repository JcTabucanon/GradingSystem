<header class="fixed z-30 w-full bg-gray-900 border-b border-gray-200">
  <nav class="flex items-center justify-between p-3">
    <div class="flex items-center bg-gray-500 justify-start">
      <a href="#" class="ml-3 text-xl font-bold text-white uppercase transition duration-75">Student Grading System - PITT</a>
    </div>
