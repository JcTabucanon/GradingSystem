        ...
        <div class="p-6 space-y-6">
          <div class="modal-grid">
            <div class="col-span-6 sm:col-span-3">
              <label for="code" class="label">Department Code</label>
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <input type="text" name="deptname" class="input-field focus:ring-2 focus:ring-green-600/50 focus:border-green-600 focus:outline-none" placeholder="Department" required>
            </div>
            <div class="col-span-6 sm:col-span-3">
